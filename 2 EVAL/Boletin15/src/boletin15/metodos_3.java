...
public class metodos_3 {
        public int[] crearArray3(int[]lista){
        for(int i=0;i<lista.length;i++){
            lista[i]=(int) (Math.random()*10)+1;
        }
        return lista;
    }
    public String[] crearArray3(String[]nombre){
    ...
    public void visualizarGrupos3(int[] lista){
    ...
    public void visualizarAprobados3(int[] lista,String[]nombre){
        for(int i=0;i<lista.length;i++){
            if(lista[i]>=5){
    ...
    public void calMedia3(int[] lista){
        int media=0;
    ...
    public void notaAlta3(int[] lista,String[]nombre){
        int notaAlta=0;
        int posicion=0;
        for (int i=0;i<lista.length-1;i++){
            if(lista[i]>notaAlta){
    ...
    public void ordenarNotas3(int[]lista,String[]nombre){
        int aux;
        String auxs;
        for (int i=0;i<lista.length-1;i++){
    ...
    public void mostrarNota3(int[]lista,String[]nombre){
